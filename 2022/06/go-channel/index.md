...
{{% figure class="center" width="100%" src="/images/golang/2.png" alt="img" %}}

当有`goroutine`向`channel`发送数据时

{{% figure class="center" width="100%" src="/images/golang/3.png" alt="img" %}}
...
{{% figure class="center" width="100%" src="/images/golang/4.png" alt="img" %}}
...
{{< image src="/images/golang/5.png" width="100%" caption="图片描述" alt="11">}}
## 无数据channel 
